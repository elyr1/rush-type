...
export const SHUTTER_K = [0.62, 1.0, 0.34];
export const REST_CAP_FRAC = 0.09;
export const DRIFT_DIR = [-1, 0.7, -0.45, 1];
export const FALL = [1.0, 0.557, 0.121, 0.049, 0.014, 0.0];
export const RISE = [0.0, 0.08, 0.8, 1.0];
export function sampleTable(table, u) {
...
export function orbitTurn(psi, amp, lag) {
...
export const ORBIT_IN = [0.0, 0.5, 0.82, 0.95, 1.0, 1.0];
export const ORBIT_OUT = [0.0, 0.05, 0.14, 0.38, 1.0];
